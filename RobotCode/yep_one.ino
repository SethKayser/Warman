...
// ----- Pitch movements -----
constexpr unsigned long PITCH_DOWN_STEPS       = 600;
constexpr unsigned long PITCH_UP_STEPS_ONE     = 2000;
constexpr unsigned long PITCH_UP_STEPS_TWO     = 1100;

// ----- Extension movements -----
constexpr unsigned long EXTENSION_START_STEPS           = 650;
...
constexpr int SERVO_LEVEL_ANGLE_ONE = 120;
constexpr int SERVO_LEVEL_ANGLE_TWO = 120;
...
constexpr unsigned long DRIVE_TIME_MS = 3800;
...
void runNextStep() {
  ...
  switch (sequenceStep) {
    ...
    case 11:
      ...
      movePitchUpWithServoLevel(PITCH_UP_STEPS_TWO, SERVO_LEVEL_ANGLE_TWO);
